...
class User
{
     ...
     */
    private $email;
    //orphanRemoval when video has no user will remove not be nullable
    /**
     * @ORM\OneToMany(targetEntity=Video::class, mappedBy="user",orphanRemoval=true)
     */
    private $videos;
    //persist Meanwhile i can create user with address even if address not created successfully
    /**
